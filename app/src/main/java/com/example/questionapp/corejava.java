...
PDFView corejava;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_corejava);

        corejava=(PDFView)findViewById(R.id.corejavabook);

        corejava.fromAsset("corejava.pdf").load();
    ...
    public void download()
    {
        ...
        ref=storageReference.child("corejava.pdf");

        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                String url=uri.toString();
                dawnloadFile(corejava.this,"corejava","pdf",DIRECTORY_DOWNLOADS,url);
