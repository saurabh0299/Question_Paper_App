...
PDFView calculus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calculus=(PDFView)findViewById(R.id.calculusbook);

        calculus.fromAsset("calculus.pdf").load();




        down4=findViewById(R.id.down5);
    ...
    public void download()
    {
        ...
        ref=storageReference.child("calculus.pdf");

        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                String url=uri.toString();
                dawnloadFile(calculus.this,"calculus","pdf",DIRECTORY_DOWNLOADS,url);
