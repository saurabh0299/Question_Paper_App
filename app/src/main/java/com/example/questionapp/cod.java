...
public class cod extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        codbook=(PDFView)findViewById(R.id.codbook);

        codbook.fromAsset("cod.pdf").load();
    ...
    public void download()
    {
        ...
        ref=storageReference.child("cod.pdf");

        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                String url=uri.toString();
                dawnloadFile(cod.this,"cod","pdf",DIRECTORY_DOWNLOADS,url);
