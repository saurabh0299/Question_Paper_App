...
PDFView dbmsbook;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbmsbook=(PDFView)findViewById(R.id.dbmsbook);

        dbmsbook.fromAsset("dbms.pdf").load();




        down12=findViewById(R.id.down13);
    ...
    public void download()
    {
        ...
        ref=storageReference.child("dbms.pdf");

        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                String url=uri.toString();
                dawnloadFile(dbms.this,"dbms","pdf",DIRECTORY_DOWNLOADS,url);
