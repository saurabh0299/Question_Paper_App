...
public class android extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        andro=(PDFView)findViewById(R.id.androidbook);

        andro.fromAsset("android.pdf").load();
    ...
    public void download()
    {
        ...
        ref=storageReference.child("android.pdf");

        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                String url=uri.toString();
                dawnloadFile(android.this,"android","pdf",DIRECTORY_DOWNLOADS,url);
