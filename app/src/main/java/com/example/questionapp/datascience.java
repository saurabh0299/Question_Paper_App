...
PDFView datasc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datasc=(PDFView)findViewById(R.id.datascbook);

        datasc.fromAsset("datascience.pdf").load();




        down10=findViewById(R.id.down11);
    ...
    public void download()
    {
        ...
        ref=storageReference.child("data science.pdf");

        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                String url=uri.toString();
                dawnloadFile(datascience.this,"data science","pdf",DIRECTORY_DOWNLOADS,url);
